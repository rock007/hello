...
namespace sandy
{
    namespace Private  
    {
        ...
        template<class VALUE>
            struct __Node12  //节点struct
        {
            typedef __Node12<VALUE>* POINTER;
            ...
            __Node12():data(0)
            {
                memset(ptr,0,sizeof(POINTER)*12);
            }
        };
#ifdef __WIN32__
    }
    ...
    {
#ifdef __WIN32__
        typedef  Private::__Node12<VALUE> NODE;
#else
        typedef  __Node12<VALUE> NODE;
#endif
    ...
    public:
        CTree12():m_lcount(0),m_lnodecount(0),m_proot(CreateNode()) //notice:Keep order with their declare
        {
        }
