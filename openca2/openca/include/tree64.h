...
namespace sandy
{
    namespace Private  
    {
        ...
        template<class VALUE>
            struct __Node64  //节点struct
        {
            typedef __Node64<VALUE>* POINTER;
            ...
            __Node64():data(0)
            {
                memset(ptr,0,sizeof(POINTER)*64);
            }
        };
#ifdef __WIN32__
    }
    ...
    {
#ifdef __WIN32__
        typedef  Private::__Node64<VALUE> NODE;
#else
        typedef  __Node64<VALUE> NODE;
#endif
    ...
    public:
        CTree64():m_lcount(0),m_lnodecount(0),m_proot(CreateNode()) //notice:Keep order with their declare
        {
        }
