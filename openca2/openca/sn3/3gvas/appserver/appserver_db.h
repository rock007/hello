...
//TANG 2010-8-31 22:05
#define BUSS_FETION		'Z'
#define BUSS_VAS		'Y'
...
extern t_int appserver_dbinsert_bussop_result_fetion(t_pcstr tablename, t_pcstr s_bussopid, t_int i_seq, t_char c_flag, t_pcstr starttime, float delay, t_pcstr value);

extern t_int appserver_dbinsert_report_stat(t_int i_count, t_pcstr starttime, t_pcstr endtime, t_pcstr model, t_pcstr address, t_pcstr operater, t_pcstr terminalid, t_pcstr s_bussopid);
extern t_int appserver_dbinsert_report_stat_detail(t_int report_id, t_pcstr terminalid, t_pcstr kqi_id, t_pcstr kqi_name, int i_seq, t_pcstr starttime, t_pcstr endtime, t_pcstr value);

extern t_int appserver_dbinsert_error_log(t_pcstr filename, t_pcstr reason);

extern string db_search_bussopid_by_tid(const string & tid);
