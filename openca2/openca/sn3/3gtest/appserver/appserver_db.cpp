...
int create_db_tables()
{
  ...
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_CONTENT_CQT` (\n\
  ...
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_CONTENT_FTP` (\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  ...
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_CONTENT_HTTP` (\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `TIMES` int(11) NOT NULL DEFAULT '3',\n\
  `TMOUT` int(11) NOT NULL DEFAULT '20',\n\
  `URL` varchar(250) NOT NULL DEFAULT '127.0.0.1',\n\
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_CONTENT_PESQ` (\n\
  `BUSSOP_ID` varchar(64) NOT NULL,\n\
  ...
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_CONTENT_PING` (\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `TIMES` int(11) NOT NULL DEFAULT '3',\n\
  ...
  PRIMARY KEY (`BUSSOP_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_EXCEPTION_RESULT` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL,\n\
  `BUSSOPEXEC_ID` varchar(32) NOT NULL,\n\
  PRIMARY KEY (`COMM_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_CDMAPARAM` (\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  ...
  PRIMARY KEY (`BUSSOP_ID`,`SEQ`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_CQT` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `FREQUENCY_CONNECT` float NOT NULL DEFAULT '100',\n\
  `FREQUENCY_LOST` float NOT NULL DEFAULT '0',\n\
  `TMDELAY_CALL` float NOT NULL DEFAULT '0',\n\
  PRIMARY KEY (`COMM_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_FTP` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `SEQ` int(11) NOT NULL DEFAULT '1',\n\
  `URL` varchar(250) NOT NULL DEFAULT '',\n\
  `USETIME` double NOT NULL DEFAULT '0',\n\
  `FILESIZE` int(11) NOT NULL DEFAULT '0',\n\
  `SUCC_FLAG` varchar(5) NOT NULL DEFAULT 'S',\n\
  PRIMARY KEY (`COMM_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_HTTP` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `SEQ` int(11) NOT NULL DEFAULT '1',\n\
  ...
  `LOG_TYPE` char(1) NOT NULL DEFAULT 'H',\n\
  PRIMARY KEY (`COMM_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_PESQ` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `SRCFNAME` varchar(20) NOT NULL,\n\
  `CALLER` varchar(20) NOT NULL DEFAULT '',\n\
  `CALLED` varchar(20) NOT NULL DEFAULT '',\n\
  `pDSTFNAME` varchar(100) NOT NULL,\n\
  `pDone` int(11) NOT NULL,\n\
  `pRESULT1` float DEFAULT NULL,\n\
  `pRESULT2` float DEFAULT NULL,\n\
  `pRESULT3` float DEFAULT NULL,\n\
  `tDSTFNAME` varchar(100) NOT NULL DEFAULT '',\n\
  `tDone` int(11) NOT NULL DEFAULT '0',\n\
  `tRESULT1` float DEFAULT '0',\n\
  `tRESULT2` float DEFAULT '0',\n\
  `tRESULT3` float DEFAULT '0',\n\
  PRIMARY KEY (`COMM_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_PING` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `SEQ` int(11) NOT NULL DEFAULT '1',\n\
  `SUCC_FLAG` varchar(1) NOT NULL DEFAULT 'S',\n\
  ...
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_QUERYVERSION` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  ...
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_ROLLBACKVERSION` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `CUR_VERSION` varchar(6) NOT NULL DEFAULT '',\n\
  `SUCC_FLAG` varchar(1) NOT NULL DEFAULT 'S',\n\
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_RESULT_UPDATEVERSION` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL DEFAULT '',\n\
  `CUR_VERSION` varchar(6) NOT NULL DEFAULT '',\n\
  `BACK_VERSION` varchar(6) NOT NULL DEFAULT '',\n\
  ...
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `BUSSOP_SMS` (\n\
  `ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `BUSSOP_ID` varchar(64) NOT NULL,\n\
  `TERMINAL_ID` varchar(20) NOT NULL,\n\
  `SMS` varchar(255) NOT NULL,\n\
  `FLAG` char(1) NOT NULL,\n\
  `CURTIME` varchar(20) NOT NULL,\n\
  PRIMARY KEY (`ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `CONFIG_BUSS` (\n\
  `BUSS_TYPE` varchar(1) NOT NULL,\n\
  `DES` varchar(100) NOT NULL DEFAULT '',\n\
  PRIMARY KEY (`BUSS_TYPE`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `CONFIG_BUSSOP` (\n\
  ...
  PRIMARY KEY (`BUSSOP_TYPE`)\n\
	...
	DB1.db_create("CREATE TABLE `CONFIG_BUSSOP_ERRORS` (\n\
  `RES_CODE` int(11) NOT NULL DEFAULT '0',\n\
  `RES_DES` varchar(250) NOT NULL DEFAULT '',\n\
  PRIMARY KEY (`RES_CODE`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create(("CREATE TABLE `CONFIG_BUSSOP_EXCEPTION` (\n\
  `BUSSOPEXEC_ID` varchar(32) NOT NULL DEFAULT '',\n\
  `BUSSOP_TYPE` varchar(2) NOT NULL DEFAULT '',\n\
  `BUSSOPEXEC_TYPE` varchar(32) NOT NULL DEFAULT '',\n\
  `BUSSOPEXEC_LEVEL` varchar(1) NOT NULL DEFAULT 'A',\n\
  `DES` varchar(100) NOT NULL DEFAULT '',\n\
  `TIMES_MAX` int(11) NOT NULL,\n\
  `TIMES_MIN` int(11) NOT NULL,\n\
  `TIMES` int(11) NOT NULL DEFAULT '1' COMMENT '不再使用了',\n\
  `MINVALUE` varchar(15) NOT NULL DEFAULT '',\n\
  `MAXVALUE` varchar(15) NOT NULL DEFAULT '',\n\
  `DISPLAY` varchar(20) NOT NULL,\n\
  `RECALC_TIME` datetime NOT NULL,\n\
  `READ_ONLY_1` int(11) NOT NULL,\n\
  `READ_ONLY_2` int(11) NOT NULL,\n\
  `DISABLE` int(11) NOT NULL,\n\
  PRIMARY KEY (`BUSSOPEXEC_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8"));
	
	DB1.db_create("CREATE TABLE `CONFIG_CDMAPARAM` (\n\
  ...
  `FLAG_IN_LOG` varchar(1) NOT NULL DEFAULT 'F',\n\
  PRIMARY KEY (`CDMAPARAM_CODE`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `CONFIG_RECORDFILE` (\n\
  `FNAME` varchar(150) NOT NULL,\n\
  `DES` varchar(100) NOT NULL DEFAULT '',\n\
  PRIMARY KEY (`FNAME`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `CONFIG_SYSTEM` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  ...
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `CONFIG_TERMINAL` (\n\
  `TERMINAL_ID` varchar(20) NOT NULL,\n\
  `TERMINAL_NAME` varchar(100) NOT NULL DEFAULT '',\n\
  `CITY_HOUSE_ID` int(11) NOT NULL DEFAULT '0',\n\
  `TERMINAL_ADDRESS` varchar(128) NOT NULL,\n\
  `TERMINAL_STATE` int(11) NOT NULL DEFAULT '0',\n\
  `T_RECV_HEARTBEAT` int(11) NOT NULL DEFAULT '0',\n\
  `HEARTBEAT_STATE` int(11) NOT NULL DEFAULT '0',\n\
  `MAINPHONE1` varchar(20) NOT NULL,\n\
  ...
  `HEARTPHONE` varchar(20) NOT NULL,\n\
  PRIMARY KEY (`TERMINAL_ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `CONFIG_TERMINAL_CDMAPARAM` (\n\
  `TERMINAL_ID` varchar(20) NOT NULL,\n\
  ...
  PRIMARY KEY (`TERMINAL_ID`,`CDMAPARAM_CODE`)\n\
	...
	DB1.db_create("CREATE TABLE `CONFIG_TERMINAL_ROUTINE` (\n\
  `TERMINAL_ID` varchar(20) NOT NULL,\n\
  `STARTTIME` varchar(16) NOT NULL,\n\
  `TYPE` varchar(32) NOT NULL,\n\
  `FLAG_CDMA` varchar(1) NOT NULL DEFAULT 'F',\n\
  `URL` varchar(255) NOT NULL,\n\
  `PARA1` varchar(16) NOT NULL,\n\
  `PARA2` varchar(16) NOT NULL,\n\
  `PARA3` varchar(16) NOT NULL,\n\
  `PARA4` varchar(16) NOT NULL,\n\
  `PARA5` varchar(16) NOT NULL,\n\
  `PARA6` varchar(16) NOT NULL,\n\
  PRIMARY KEY (`TERMINAL_ID`,`STARTTIME`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `DICTIONARY_3GTEST` (\n\
  ...
  PRIMARY KEY (`TABLE_NAME`,`COLUMN_NAME`)\n\
	...
	DB1.db_create("CREATE TABLE `USERS` (\n\
  `COMM_ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `USER_NAME` varchar(24) NOT NULL DEFAULT '',\n\
  ...
  PRIMARY KEY (`COMM_ID`)\n\
	...
	DB1.db_create("CREATE TABLE `YW_HOUSE_INFORMATION` (\n\
  `ID` int(11) NOT NULL,\n\
  `HOUSE_NAME` varchar(255) DEFAULT NULL,\n\
  `HOUSE_REGIONAL_ID` int(11) DEFAULT NULL,\n\
  `HOUSE_HOT_REGIONAL_ID` int(11) DEFAULT NULL,\n\
  `HOUSE_LOCATION` varchar(45) DEFAULT NULL,\n\
  PRIMARY KEY (`ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
	
	DB1.db_create("CREATE TABLE `YW_REGIONAL_INFORMATION` (\n\
  `ID` int(11) NOT NULL AUTO_INCREMENT,\n\
  `REGIONAL_NAME` varchar(255) DEFAULT NULL,\n\
  `REGIONAL_TYPE` int(11) DEFAULT NULL,\n\
  PRIMARY KEY (`ID`)\n\
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
